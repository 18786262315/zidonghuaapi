...
class TestWebBranchOrderSearch(unittest.TestCase):
    ...
    def setUp(self):
        self.datafile = '../../datacase/search_datacase/web_branch_order_search.xls'
    ...
    def test_branchViolateManageSearch(self):
        '''违规管理（网点）列表查询'''
        datafile = self.datafile
        loadDatas(self, datafile, u'branchViolateManageSearch')
