...
class TestWebFrontendSearch(unittest.TestCase):
    ...
    def setUp(self):
        self.datafile = '../../datacase/search_datacase/web_frontend_search.xls'
    ...
    def test_trunkViolateManageSearch(self):
        '''违规管理（物流）列表查询'''
        datafile = self.datafile
        loadDatas(self, datafile, u'trunkViolateManageSearch')
